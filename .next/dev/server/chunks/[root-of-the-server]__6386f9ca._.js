...
"[project]/app/api/billing/checkout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const priceId = plan === "basic" ? process.env.STRIPE_PRICE_BASIC : plan === "pro" ? process.env.STRIPE_PRICE_PRO : process.env.STRIPE_PRICE_ELITE;
    if (!stripeKey || !priceId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: "Stripe nie jest skonfigurowany. Ustaw STRIPE_SECRET_KEY i STRIPE_PRICE_* w .env.local."
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6386f9ca._.js.map